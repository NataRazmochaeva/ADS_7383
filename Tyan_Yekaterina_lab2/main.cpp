...
void errors(int err) {
    switch(err) {
        ...
        case 2:
             ...
             break;
        case 3:
            cerr<<"Не хвататет значений, констант или знако33333в. Проверьте введенные данные и повторите попытку."<<endl;
            break;
        case 4:
            cerr << "Неверный ввод."<<endl;
            break;
...
bool write(lisp head,int i,int j,bool* flag){
    if(head==NULL){
        ...
        cerr<<"Не хвататет значений, констант или знаков. Проверьте вве111111денные данные и повторите попытку."<<endl;
        return false;
    }else{
        i++;
...
bool write_lisp(lisp head, int i,int j,bool* flag){
    if(head==NULL){
        cerr<<"Не хвататет значений, констант 222222или знаков. Проверьте введенные данные и повторите попытку."<<endl;
        return false;
    }
    if(head->tag==true){
        for(int j=0;j< i;j++)
